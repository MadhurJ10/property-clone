...
const teamMembers = [
  {
    name: 'MR. ANIL BANSAL',
    title: 'Chairman – Lotus Valley',
    image: rizwanImg,
    description: 'Chairman of Lotus Valley',
  ...
  },
  {
    ...
    about: 'Mr. Chirag Bansal embodies youthful dynamism within the esteemed Lotus Valley, holding the distinction as its youngest member. With a Bachelor\'s Degree in Civil Engineering from Penn State University, he stands as a beacon of leadership in steering the trajectory of Lotus Valley Construction Work\'s new endeavors.',
  },
  {
    ...
    image: adelImg,
    description: 'Managing Director',
    about: 'Mr. Kartik Bansal, a visionary leader with a degree in Industrial Engineering from Penn State University, adeptly oversees Lotus Valley Hospital, Lotus Valley TMT Sariya, and Lotus Valley One. His strategic acumen and innovative marketing strategies drive remarkable success. Fostering collaboration, he aims to elevate Lotus Valley to a leading conglomerate in India.',
  },
  {
    ...
    image: member4Img,
    description: 'Managing Director',
    about: 'Kunal Bansal, an industrious Penn State University Industrial Engineering Graduate, skillfully manages Lotus Valley Constructions and Lotus Valley Oil & Foods. His innovative marketing and decisive leadership are pivotal to their success. A collaborative strategist, he aims to propel Lotus Valley among India\'s foremost conglomerates.',
  },
  {
